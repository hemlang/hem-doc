...
Arrays in Hemlock sind **dynamische, heap-allokierte** Sequenzen, die gemischte Typen enthalten können. Sie bieten umfassende Methoden zur Datenmanipulation und -verarbeitung.
...
Arrays unterstützen nullbasierte Indizierung mit `[]`:
...
**Hinweis:** Direkter Indexzugriff hat keine Grenzenprüfung. Verwenden Sie Methoden für Sicherheit.
...
Entfernt und gibt das letzte Element zurück.
...
**Rückgabe:** Letztes Element (aus Array entfernt)
...
Entfernt und gibt das erste Element zurück.
...
**Rückgabe:** Erstes Element (aus Array entfernt)
...
Entfernt und gibt das Element am Index zurück.
...
**Fehler:** Laufzeitfehler wenn Index außerhalb der Grenzen.
...
**Vergleich:** Verwendet Wertgleichheit für Primitive und Strings.
...
**Rückgabe:** Neues Array mit Elementen von [start, end)
...
Gibt das letzte Element zurück ohne es zu entfernen.
...
**Rückgabe:** Neues Array mit Elementen aus beiden Arrays
...
print(a);                    // [1, 2, 3] (unverändert)
print(b);                    // [4, 5, 6] (unverändert)
...
**Parameter:**
- `callback` - Funktion die ein Element nimmt und transformierten Wert zurückgibt

**Rückgabe:** Neues Array mit transformierten Elementen
...
**Rückgabe:** String mit allen verbundenen Elementen
...
|------------|----------------------------|-----------|--------------------------------|
| `push`     | `(value: any)`             | `null`    | Am Ende hinzufügen            |
| `pop`      | `()`                       | `any`     | Vom Ende entfernen             |
| `shift`    | `()`                       | `any`     | Vom Anfang entfernen           |
| `unshift`  | `(value: any)`             | `null`    | Am Anfang hinzufügen          |
| `insert`   | `(index: i32, value: any)` | `null`    | An Index einfügen             |
...
Methoden die neue Werte zurückgeben ohne das Original zu modifizieren:

| Methode    | Signatur                   | Rückgabe | Beschreibung                   |
|------------|----------------------------|-----------|--------------------------------|
| `find`     | `(value: any)`             | `i32`     | Erstes Vorkommen finden        |
| `contains` | `(value: any)`             | `bool`    | Prüfen ob Wert enthalten      |
...
- Funktioniert korrekt für Primitive und Strings
