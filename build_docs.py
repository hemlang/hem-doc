...
# Welcome page content for each language (built into hem-doc, not from hemlock repo)
WELCOME_PAGE_CONTENT = {
    'en': '''# Welcome to Hemlock
...
def collect_docs(lang='en'):
    ...
    # Add Welcome page first (built into hem-doc, not from hemlock repo)
    welcome_content = WELCOME_PAGE_CONTENT.get(lang, WELCOME_PAGE_CONTENT['en'])
